...
/*
 * ABI note: the public value/output structures in this header are fixed-layout
 * for the 1.x ABI. Extend them through a new type/function, not by appending
 * fields in place. See docs/abi-compatibility.md.
 */
