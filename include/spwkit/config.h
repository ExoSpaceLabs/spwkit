...
/*
 * Stable 1.x prefix. Compatible 1.x revisions may append fields only; callers
 * advertise the bytes they provide through struct_size.
 */
#define SPW_PORT_CONFIG_MIN_SIZE \
