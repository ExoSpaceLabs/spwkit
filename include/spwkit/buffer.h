...
SPWKIT_API spw_result_t spw_buffer_get_view(const spw_buffer_t* buffer,
 ...
 */
SPWKIT_API spw_result_t spw_buffer_set_packet(spw_buffer_t* buffer,
                                   size_t length,
                                   spw_terminator_t terminator);

/** Acquire an application-owned TX buffer with at least min_capacity bytes. */
SPWKIT_API spw_result_t spw_port_acquire_tx_buffer(spw_port_t* port,
                                        size_t min_capacity,
 ...
 */
SPWKIT_API spw_result_t spw_port_submit_tx_buffer(spw_port_t* port,
                                       spw_buffer_t** inout_buffer,
                                       spw_timeout_us_t timeout_us);

/** Reclaim one completed TX buffer back into application ownership. */
SPWKIT_API spw_result_t spw_port_reclaim_tx_buffer(spw_port_t* port,
                                        spw_timeout_us_t timeout_us,
                                        spw_buffer_t** out_buffer);

/** Return an application-owned TX buffer to the backend pool. */
SPWKIT_API spw_result_t spw_port_release_tx_buffer(spw_port_t* port,
                                        spw_buffer_t** inout_buffer);

/** Acquire the next received packet as an application-owned RX buffer. */
SPWKIT_API spw_result_t spw_port_acquire_rx_buffer(spw_port_t* port,
                                        spw_timeout_us_t timeout_us,
                                        spw_buffer_t** out_buffer);
 ...
 */
SPWKIT_API spw_result_t spw_port_release_rx_buffer(spw_port_t* port,
                                        spw_buffer_t** inout_buffer);
