...
#define SPW_VSPW_TP_MAX_CARRIER_FRAME 65507u
/* Compatibility alias for the original UDP-only implementation. */
#define SPW_VSPW_TP_MAX_UDP_PAYLOAD SPW_VSPW_TP_MAX_CARRIER_FRAME
#define SPW_VSPW_TP_MAX_FRAGMENT_PAYLOAD \
    (SPW_VSPW_TP_MAX_CARRIER_FRAME - SPW_VSPW_TP_HEADER_SIZE)
